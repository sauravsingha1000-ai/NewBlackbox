...
bool FileSystemHook::install() {
    bool ok = true;
    ok &= hookFunction((void*)open,    (void*)hook_open,    (void**)&orig_open);
    ok &= hookFunction((void*)stat,    (void*)hook_stat,    (void**)&orig_stat);
    ok &= hookFunction((void*)access,  (void*)hook_access,  (void**)&orig_access);
    ok &= hookFunction((void*)opendir, (void*)hook_opendir, (void**)&orig_opendir);
    ok &= hookFunction((void*)rename,  (void*)hook_rename,  (void**)&orig_rename);
    ok &= hookFunction((void*)unlink,  (void*)hook_unlink,  (void**)&orig_unlink);
    ok &= hookFunction((void*)mkdir,   (void*)hook_mkdir,   (void**)&orig_mkdir);
    ok &= hookFunction((void*)rmdir,   (void*)hook_rmdir,   (void**)&orig_rmdir);
